...
const struct Tileset gTileset_CafeDotGeneral =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_CafeDotGeneral,
    .palettes = gTilesetPalettes_CafeDotGeneral,
    .metatiles = gMetatiles_CafeDotGeneral,
