...
// Medicine
    ...
    [ITEM_SACRED_ASH] =
    {
        .name = ITEM_NAME("Pokéchow Soup"),
        .pluralName = ITEM_PLURAL_NAME("Pokéchow Soup"),
        ...
        .sortType = ITEM_TYPE_HEALTH_RECOVERY,
        .type = ITEM_USE_PARTY_MENU,
        .battleUsage = EFFECT_ITEM_CDGJ_REVIVE_ALL,
...
// Misc. Key Items
    ...
    {
        .name = ITEM_NAME("S. Ingredient Rock"),
        .price = 0,
        .description = COMPOUND_STRING(
            "This would be\n"
            "delicious in the\n"
...
// Story Key Items
    ...
    [ITEM_EON_TICKET] =
    {
        .name = ITEM_NAME("S. Ingredient Berry"),
        .price = 0,
        .description = COMPOUND_STRING(
            "This would be\n"
            "delicious in the\n"
    ...
    [ITEM_MYSTIC_TICKET] =
    {
        .name = ITEM_NAME("S. Ingredient Water"),
        .price = 0,
        .description = COMPOUND_STRING(
            "This would be\n"
            "delicious in the\n"
